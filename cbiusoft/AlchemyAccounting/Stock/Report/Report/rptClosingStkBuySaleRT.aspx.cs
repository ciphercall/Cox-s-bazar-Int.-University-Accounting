...
" WHERE     (B.CLQTY <> 0)", conn);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string BUYVALUE = Buy_V.ToString("#,##0.00");
                ...
                string SALEVALUE = Sale_V.ToString("#,##0.00");
                ...
                dblSubTotalBuyAmountComma = dblSubTotalBuyAmount.ToString("#,##0.00");

                dblSubTotalSaleAmount += dblSaleAmount;
                dblSubTotalSaleAmountComma = dblSubTotalSaleAmount.ToString("#,##0.00");
                ...
                dblGrandTotalBuyAmountComma = dblGrandTotalBuyAmount.ToString("#,##0.00");
                dblGrandTotalSaleAmount += dblSaleAmount;
                dblGrandTotalSaleAmountComma = dblGrandTotalSaleAmount.ToString("#,##0.00");
