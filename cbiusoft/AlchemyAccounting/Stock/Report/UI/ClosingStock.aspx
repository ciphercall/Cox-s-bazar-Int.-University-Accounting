<%@ Page Title="Store Wise Closing Stock & Value" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ClosingStock.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.UI.ClosingStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;font-family:Century Gothic;">Store Wise Closing Stock & Value</h1>
    </div>
