<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApplicationForReg1.aspx.cs" Inherits="AlchemyAccounting.Admission.UI.ApplicationForReg1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function pageLoad() {
            $("#txtAdmDT,#txtDOB").datepicker({ dateFormat: "dd/mm/yy", changeMonth: true, changeYear: true, yearRange: "-100:+5" });
        }
        //function pageLoad() {
                ...
                <table class="nav-justified">
                    ...
                    <tr>
                        ...
                        <td class="auto-style5">
                            <asp:TextBox ID="txtAdmDT" runat="server" ClientIDMode="Static" CssClass="form-control" Height="30px" Width="100%" AutoPostBack="True" OnTextChanged="txtAdmDT_TextChanged" MaxLength="10"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style6">
                            <asp:DropDownList ID="ddlSemNM" runat="server" CssClass="form-control" Height="30px" Width="100%" OnSelectedIndexChanged="ddlSemNM_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td class="auto-style4" colspan="2">Program Name <span class="auto-style18">*</span>:</td>
                        <td class="auto-style5">
                            <asp:DropDownList ID="ddlProNM" runat="server" CssClass="form-control" Height="30px" Width="100%" OnSelectedIndexChanged="ddlProNM_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style6" width="33%">
                            <asp:TextBox ID="txtSession" runat="server" ClientIDMode="Static" Height="30px" Width="50%" CssClass="form-control" MaxLength="6"></asp:TextBox>
                            <asp:TextBox ID="txtStuMaxID" runat="server" ClientIDMode="Static" CssClass="form-control" Height="30px" Width="50%" MaxLength="11"></asp:TextBox>
                        </td>
                        <td class="auto-style4" colspan="2">Batch :</td>
                        <td class="auto-style5">
                            <asp:TextBox ID="txtBCH" runat="server" Height="30px" Width="100%" CssClass="form-control" MaxLength="20"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style5">
                            <asp:DropDownList ID="ddlAdmtTP" runat="server" CssClass="form-control" Height="30px" OnSelectedIndexChanged="ddlProNM_SelectedIndexChanged" Width="100%">
                                <asp:ListItem>Select</asp:ListItem>
                                <asp:ListItem>Regular</asp:ListItem>
                                <asp:ListItem>Credit Transfer</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td class="auto-style4">Waiver&nbsp; :</td>
                        <td class="auto-style6" width="33%">
                            <asp:TextBox ID="txtWaiver" runat="server" CssClass="form-control Center" Height="30px" MaxLength="100" Width="50%" Text="0.00"></asp:TextBox>
                            <strong><span class="auto-style19">&nbsp; </span><span class="auto-style20">%</span></strong></td>
                        <td class="auto-style4" colspan="2">Scholarship :</td>
                        <td class="auto-style5">
                            <asp:TextBox ID="txtWaiver0" runat="server" CssClass="form-control Center" Height="30px" MaxLength="100" Text="0.00" Width="50%"></asp:TextBox>
                            <strong><span class="auto-style19">&nbsp;</span><span class="auto-style20">%</span></strong></td>
                        <td>&nbsp;</td>
                    </tr>
            ...
            <asp:TextBox ID="txtnm" runat="server"></asp:TextBox>
                ...
                <asp:Button ID="btnEdit" runat="server" Text="Edit" CommandName="Edit" />
                    ...
                    <tr>
                        ...
                        <td class="auto-style6" colspan="5">
                            <table class="nav-justified">
                                <tr>
                                    <td width="10%">
                                        <asp:Button ID="btnAdd" runat="server" Text="Add" Width="100%" CssClass="form-control" OnClick="btnAdd_Click" Height="100%" ValidationGroup="Add" />
                                    </td>
                                    <td width="10%">
                    ...
                    <tr>
                        ...
                        <td class="auto-style4" colspan="2">&nbsp;</td>
                        <td class="auto-style5">
                            <asp:Button ID="btnSUBMIT" runat="server" BackColor="White" CssClass="form-control-right" Font-Bold="True" Font-Size="12pt" ForeColor="Black" Height="100%" OnClick="btnSUBMIT_Click" Text="Submit" ValidationGroup="Submit" Width="120px" BorderColor="#3399FF" BorderWidth="2px" />
                            <asp:Button ID="btnDLT" runat="server" OnClientClick="return confMSG()" BackColor="White" BorderColor="#3399FF" BorderWidth="2px" CssClass="form-control" Font-Bold="True" ForeColor="Black" Height="100%" OnClick="btnDLT_Click" Text="Delete" Width="120px" ValidationGroup="Delete" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
