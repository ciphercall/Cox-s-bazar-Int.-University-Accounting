<%@ Page Title="Summarized Statement" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="SumarizedStatement.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.UI.SumarizedStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;">Sale/purchase/return statement - party</h1>
    </div>
    <div>
        <table id="s_top">
            <tr>
