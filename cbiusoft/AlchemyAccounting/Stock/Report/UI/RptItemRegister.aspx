<%@ Page Title="Item Register" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="RptItemRegister.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.UI.RptItemRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;">ITEM REGISTER</h1>
    </div>
    <div>
        <table id="s_top">
            <tr>
            ...
            <tr>
                ...
                <td class="style2">
                        <asp:DropDownList ID="ddlStore" runat="server" 
                            ...
                            AutoPostBack="True" TabIndex="1" Width="350px">
