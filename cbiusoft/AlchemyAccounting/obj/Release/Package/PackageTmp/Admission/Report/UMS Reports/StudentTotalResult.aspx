<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentTotalResult.aspx.cs" Inherits="AlchemyAccounting.Admission.Report.UMS_Reports.StudentTotalResult" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
     <title>Student Wise Total Result</title>  
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="RESULT" runat="server"><ContentTemplate>
    ...
    <div style="border-top-left-radius:10px; border-top-right-radius:10px;border-bottom-left-radius:10px;border-bottom-right-radius:10px; width:350px; margin:0 auto; text-align: center; color: #FFFFFF; background-color: #666666; font-weight: 700; font-size: x-large;" class="auto-style5" >Student Wise Result</div>
        <hr />
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Label ID="lblOldStudent" runat="server" ForeColor="Red" Visible="false"></asp:Label>
                    </td>
                    <td>
                        <br />
                        <br />
