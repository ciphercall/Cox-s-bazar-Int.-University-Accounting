<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="rpt-workingHour-Daily-Form.aspx.cs" Inherits="AlchemyAccounting.payroll.report.ui.rpt_workingHour_Daily_Form" %>
    ...
    <div class="def">
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 20%">
                    <asp:TextBox runat="server" ID="txtFromDate" CssClass="txtColor" Width="100%" AutoPostBack="True"
                        OnTextChanged="txtFromDate_TextChanged"></asp:TextBox>
                    <asp:CalendarExtender ID="txtEntryDate_CalendarExtender" runat="server" TargetControlID="txtFromDate"
