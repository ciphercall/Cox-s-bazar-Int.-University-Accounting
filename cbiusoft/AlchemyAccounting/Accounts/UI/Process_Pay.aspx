<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Process_Pay.aspx.cs" Inherits="AlchemyAccounting.Accounts.UI.Process_Pay" %>
        ...
        <ContentTemplate>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style3">Process-Payable</td>
                    <td class="auto-style3" style="width: 20%">&nbsp;</td>
                    <td class="auto-style3" style="width: 15%">&nbsp;</td>
                </tr>
                <tr>
