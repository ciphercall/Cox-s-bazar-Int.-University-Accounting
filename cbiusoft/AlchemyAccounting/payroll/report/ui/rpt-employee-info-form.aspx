<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="rpt-employee-info-form.aspx.cs" Inherits="AlchemyAccounting.payroll.report.ui.rpt_employee_info_form" %>
    ...
    <div class="def">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 15%">
                    <asp:TextBox runat="server" ID="txtEmpName" CssClass="txtColor" Width="80%" AutoPostBack="True"
                        TabIndex="3" OnTextChanged="txtEmpName_TextChanged"></asp:TextBox>
                    <asp:AutoCompleteExtender ID="txtexpensebNo_AutoCompleteExtender" runat="server"
                        DelimiterCharacters="" Enabled="True" ServicePath="" TargetControlID="txtEmpName"
                        MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="true" CompletionSetCount="3"
                        UseContextKey="True" ServiceMethod="GetCompletionListEmpID" CompletionListItemCssClass="listItem"
                ...
                <td style="width: 16%">
                    <asp:TextBox runat="server" ID="txtEmpID" CssClass="txtColor" Width="100%" ReadOnly="true"
