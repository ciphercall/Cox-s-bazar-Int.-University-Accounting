<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Collection_Old.aspx.cs" Inherits="AlchemyAccounting.Admission.UI.Collection" %>
            ...
            <div style="border: double; border-width: 2px; border-radius: 10px">
                ...
                &nbsp;<table class="auto-style2">
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <div class="text-left">
                                <asp:TextBox ID="txtDT" runat="server" ClientIDMode="Static" CssClass="form-control" OnTextChanged="txtDT_TextChanged" Width="120px" AutoPostBack="True" TabIndex="1" MaxLength="10"></asp:TextBox>
                                <asp:TextBox ID="txtTransNO" runat="server" CssClass="form-control" Enabled="False" EnableTheming="True" Width="50%"></asp:TextBox>
                                <asp:DropDownList ID="ddlTransNO" runat="server" AutoPostBack="True" CssClass="form-control" OnSelectedIndexChanged="ddlTransNO_SelectedIndexChanged" Visible="False" Width="100px">
                                </asp:DropDownList>
                            </div>
                            <div class="text-left">
                            </div>
                        ...
                        <td width="30%" class="text-center">
                            ...
                            <asp:DropDownList ID="ddlRegYR" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlRegYR_SelectedIndexChanged" TabIndex="2" Width="150px">
                            </asp:DropDownList>
                    ...
                    <tr>
                        <td width="20%" class="auto-style5">Semester Name&nbsp;&nbsp; :&nbsp;&nbsp; </td>
                        <td width="30%" class="text-left">
                            <asp:DropDownList ID="ddlSemNM" runat="server" CssClass="form-control" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlSemNM_SelectedIndexChanged" TabIndex="3">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <asp:TextBox ID="txtStuID" runat="server" CssClass="form-control" Width="100%" OnTextChanged="txtStuID_TextChanged" AutoPostBack="True" TabIndex="5" MaxLength="11"></asp:TextBox>
                            ...
                            <asp:AutoCompleteExtender ID="AutoCompleteExtender"
                                ...
                                TargetControlID="txtStuID" UseContextKey="True">
                            </asp:AutoCompleteExtender>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style5" colspan="5">
                           ...
                           <div class="form-control" style="text-align:left; width:98%;margin:0 auto; border:1px solid #2aabd2"><marque><asp:Label ID="lblWaiver" runat="server" style="text-align: left; color: #00CC66; font-weight: 700;" Text=""></asp:Label></marque></div> 
                        </td>
                    </tr>
                </table>
                <table class="auto-style2">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Fees Name">
                                         ...
                                         <asp:TemplateField HeaderText="Amount">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtAMOUNTEdit" CssClass="form-control" AutoPostBack="true" Width="100%" runat="server" Text='<%# Eval("PREAMOUNT") %>' OnTextChanged="txtAMOUNTEdit_TextChanged"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblAMOUNT" runat="server" Text='<%# Eval("PREAMOUNT") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Waiver">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtWaiverEdit" ReadOnly="true" runat="server" AutoPostBack="true" CssClass="form-control" Width="100%" Text='<%# Eval("WAIVER") %>' OnTextChanged="txtFEESNMEdit_TextChanged"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblWaiver" runat="server" Text='<%# Eval("WAIVER") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtWaiverFooter" TabIndex="11" ReadOnly="true" runat="server" AutoPostBack="true" CssClass="form-control" Width="100%" OnTextChanged="txtFEESNMFooter_TextChanged"></asp:TextBox>
                                            </FooterTemplate>

                                            <HeaderStyle Width="6%" HorizontalAlign="Center" />
                                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Scolership">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtWaiverSCOLREdit" ReadOnly="true" runat="server" AutoPostBack="true" CssClass="form-control" Width="100%" Text='<%# Eval("SCHOLAR") %>' OnTextChanged="txtFEESNMEdit_TextChanged"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblWaiverSCOLR" runat="server" Text='<%# Eval("SCHOLAR") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtWaiverSCOLRFooter" ReadOnly="true" TabIndex="11" runat="server" AutoPostBack="true" CssClass="form-control" Width="100%" OnTextChanged="txtFEESNMFooter_TextChanged"></asp:TextBox>
                                            </FooterTemplate>

                                            <HeaderStyle Width="6%" HorizontalAlign="Center" />
                                            <ItemStyle Width="6%" HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        <%--<asp:TemplateField HeaderText="Total Waiver">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtWaiverTotalEdit" ReadOnly="true" runat="server" AutoPostBack="true" CssClass="form-control" Width="100%" Text='<%# Eval("WAIVER") %>' OnTextChanged="txtFEESNMEdit_TextChanged"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblWaiverTotal" runat="server" Text='<%# Eval("WAIVER") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtWaiverTotalFooter" ReadOnly="true" TabIndex="11" runat="server" AutoPostBack="true" CssClass="form-control" Width="100%" OnTextChanged="txtFEESNMFooter_TextChanged"></asp:TextBox>
                                            </FooterTemplate>
                                      ...
                                      <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Total Amount">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtTotalAMOUNTEdit" ReadOnly="true" CssClass="form-control" AutoPostBack="true" Width="100%" runat="server" Text='<%# Eval("AMOUNT") %>' OnTextChanged="txtAMOUNTEdit_TextChanged"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalAMOUNT" runat="server" Text='<%# Eval("AMOUNT") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtTotalAMOUNTFooter" ReadOnly="true" TabIndex="12" runat="server" CssClass="form-control" Width="100%" AutoPostBack="true" OnTextChanged="txtAMOUNTFooter_TextChanged"></asp:TextBox>
                                            </FooterTemplate>
                                            <HeaderStyle Width="10%" />
                                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Complete" CssClass="txtColor"
                                                    Height="30px" ImageUrl="~/Images/Complete.png" TabIndex="15" ToolTip="Insert"
                                                    ValidationGroup="validaiton" Width="30px" />
                                                <asp:ImageButton ID="ImageButton2" runat="server" CommandName="Print" CssClass="txtColor"
                                                    Height="30px" ImageUrl="~/Images/print.png" TabIndex="16" ToolTip="Insert"
                                                    ValidationGroup="validaiton" Width="30px" />
                                            </FooterTemplate>
                                            <ItemTemplate>
