<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeesReportPeriodicByTrans.aspx.cs" Inherits="AlchemyAccounting.Admission.Report.UMS_Reports.FeesReportPeriodicByTrans" %>
    ...
    <div style="margin-bottom: 0px">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td style="width: 20%">
                    <asp:TextBox ID="txtFrDT" runat="server" ClientIDMode="Static" Width="100%" Height="25px" OnTextChanged="txtFrDT_TextChanged" AutoPostBack="True" CssClass="txtColor"></asp:TextBox>
                </td>
                <td style="width: 20%">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="width: 20%" class="auto-style2">
                    <asp:TextBox ID="txtToDT" ClientIDMode="Static" runat="server" Height="25px" Width="100%" OnTextChanged="txtToDT_TextChanged" AutoPostBack="True" CssClass="txtColor"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 20%">&nbsp;</td>
