...
namespace AlchemyAccounting.Accounts.Report.UI
{
    public partial class RptLedgerBook : System.Web.UI.Page
    {
        ...
        public static string[] GetCompletionList(string prefixText, int count, string contextKey)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT ACCOUNTNM FROM GL_ACCHART WHERE substring(ACCOUNTCD,1,7) not in ('1020101','1020102') and STATUSCD='P' and ACCOUNTNM LIKE '" + prefixText + "%'", conn);
