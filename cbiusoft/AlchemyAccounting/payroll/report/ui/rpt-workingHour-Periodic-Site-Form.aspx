<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="rpt-workingHour-Periodic-Site-Form.aspx.cs" Inherits="AlchemyAccounting.payroll.report.ui.rpt_workingHour_Periodic_Site_Form" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center">
             Working Hour(Summarized) - Site Wise</h1>
    </div>
    <div id="entry">
        <div id="toolbar">
    ...
    <div class="def">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 15%">
                    <asp:TextBox runat="server" ID="txtSiteNM" CssClass="txtColor" Width="90%" AutoPostBack="True"
                        OnTextChanged="txtSiteNM_TextChanged" TabIndex="3"></asp:TextBox>

                    <asp:AutoCompleteExtender ID="txtexpensebNo_AutoCompleteExtender" runat="server"
                        DelimiterCharacters="" Enabled="True" ServicePath="" TargetControlID="txtSiteNM"
                        MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="true" CompletionSetCount="3"
                        UseContextKey="True" ServiceMethod="GetCompletionListSiteID"
                ...
                <td style="width: 16%">
                    <asp:TextBox runat="server" ID="txtSiteID" CssClass="txtColor" Width="100%" ReadOnly="true"
            ...
            <tr>
                ...
                <td style="width: 15%">
                    <asp:Button ID="btnSubmit" runat="server" Font-Bold="True" Font-Names="Calibri" Font-Size="15px"
                        Text="View Report" Width="110px" OnClick="btnSubmit_Click" TabIndex="4" />
                    &nbsp;
                </td>
                <td style="width: 15%; text-align: right">
