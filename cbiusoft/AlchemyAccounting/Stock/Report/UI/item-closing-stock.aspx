<%@ Page Title="Remaining Item" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="item-closing-stock.aspx.cs" Inherits="AlchemyAccounting.Stock.Report.UI.item_closing_stock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="header">
        <h1 align="center" style="font-weight:bold;font-family:Century Gothic;">Closing Stock & Value</h1>
    </div>
